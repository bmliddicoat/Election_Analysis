...
for candidate_name in candidate_votes:
    ...
    #a To do: print out each candidate's name, vote count and percentage of 
    # voted to the terminal.

    # Determine winning vote count and candidate
    # Determine if the votes is greaters than the winning count.
...
#4. Print the candidate name, vote count and percentage of votes to terminal.
